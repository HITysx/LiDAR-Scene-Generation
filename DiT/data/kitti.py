...
from DiT.data.base import DatasetBase
...
class SemanticKITTITrain(SemanticKITTIBase):
    def __init__(self, **kwargs):
        super().__init__(data_root='/media/ysx/mydata/semanticKITTI', split='train', **kwargs)


class SemanticKITTIValidation(SemanticKITTIBase):
    def __init__(self, **kwargs):
        super().__init__(data_root='/media/ysx/mydata/semanticKITTI', split='val', **kwargs)
...
class KITTI360Base(KITTIBase):
    ...
    def load_camera(self, path):
        camera_path = path.replace('data_3d_raw', 'data_2d_raw').replace('velodyne_points/data', 'image_00/data_rect').replace('.bin', '.png')
...
class KITTI360Train(KITTI360Base):
    def __init__(self, **kwargs):
        super().__init__(data_root='/media/ysx/mydata/KITTI-360', split='train', **kwargs)


class KITTI360Validation(KITTI360Base):
    def __init__(self, **kwargs):
        super().__init__(data_root='/media/ysx/mydata/KITTI-360', split='val', **kwargs)
...
class KITTIImageTrain(KITTIImageBase):
    def __init__(self, **kwargs):
        super().__init__(data_root='/media/ysx/mydata', split='train', **kwargs)


class KITTIImageValidation(KITTIImageBase):
    def __init__(self, **kwargs):
        super().__init__(data_root='/media/ysx/mydata', split='val', **kwargs)

class NUSCENESBase(KITTIBase):
    """
    Range ImageSet only combining KITTI-360 and SemanticKITTI
